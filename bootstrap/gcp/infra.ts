...
export const gcpWorkloadIdentityPoolName = workloadIdentityPool.name;
export const gcpOidcProviderName = oidcProvider.name;
export const gcpInfraManagerSAEmail = infraManagerSA.email;